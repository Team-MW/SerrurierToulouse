    ...
    return (
        <section className="py-20 bg-white border-y border-gray-100 overflow-hidden relative">
            <div className="container mx-auto px-4 mb-12 text-center">
                <h3 className="text-2xl font-bold text-gray-800 mb-2">Ils nous ont fait confiance</h3>
            ...
            <div className="relative w-full overflow-hidden">
                ...
                >
                    ...
                    {[...carouselItems, ...carouselItems].map((partner, index) => (
                        <div
                            key={index}
                            className="flex-shrink-0 w-48 h-32 bg-white rounded-xl flex items-center justify-center p-6 border border-gray-100 shadow-sm hover:translate-y-[-4px] hover:shadow-md transition-all duration-300"
                        >
                            <img
                                src={partner.src}
                                alt={partner.alt}
